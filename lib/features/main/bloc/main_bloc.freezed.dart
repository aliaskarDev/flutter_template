...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({StateStatus status, String errorMessage});
}
...
class _$_MainState implements _MainState {
  const _$_MainState(
      {this.status = StateStatus.initial, this.errorMessage = ''});
  ...
  @override
  String toString() {
    return 'MainState(status: $status, errorMessage: $errorMessage)';
  }
...
abstract class _MainState implements MainState {
  const factory _MainState(
      {final StateStatus status, final String errorMessage}) = _$_MainState;
